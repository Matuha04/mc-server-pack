# Compute the box from the two corner markers, draw it as a PREVIEW, open the menu.
...
# horizontal edges sit on the marked blocks (no +1); vertical keeps +1 for height
...
# redraw the preview from scratch
