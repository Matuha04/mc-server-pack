...
# wand dropped -> cycle its mode and hand it back
execute as @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{gbwand:1b}}}}] at @s run function glowborder:wand_cycle
