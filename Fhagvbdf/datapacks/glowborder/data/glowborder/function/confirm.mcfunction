...
# if walls are enabled, register this region for proximity walls
execute if data storage glowborder:in {walls:1b} run function glowborder:make_wallregion with storage glowborder:tmp
